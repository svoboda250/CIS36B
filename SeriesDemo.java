...
class SeriesDemo implements Series {
    ...
    public static void main(String[] args) {
        ...
        /*
         for (int i = 0; i < 5; i++) {
         System.out.println("The volume of a cube with a side of length " + cubeTest.getNext() + " is " + (cubeTest.getNext()));
         }
         for (int i = 0; i < 5; i++) {
         System.out.println("The area of a square with a side of length " + squareTest.getNext() + " is " + squareTest.getNext());
         }
         for (int i = 0; i < 5; i++) {
         System.out.println("The area of a circle with radius " + circleTest.getNext() + " is " + (Math.PI * circleTest.getNext()));
         }    
         */
    }
    /*
